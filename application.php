...
</style><form action="Actions.php" id="application-form" class="h-100" enctype="multipart/form-data">
    <input type="hidden" name="vacancy_id" value="<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>">
    ...
    <div class="row educational mx-0 border-bottom">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select name="level[]" id="level" class="form-control form-control-sm rounded-0" required>
            ...
            <div class="form-group">
                ...
                <input type="file" name="certificate[]" id="certificate" class="form-control form-control-sm rounded-0" required>
            </div>
            <div class="form-group d-flex justify-content-end py-1 w-100">
                <div class="col-auto">
    ...
    <div class="my-2">
        ...
        <div class="w-100 d-flex justify-content-between">
            ...
            <div class="col-auto">
                ...
                <button type="submit" class="btn btn-primary btn-sm rounded-0" id="submit" style="display:none">Submit</button>
