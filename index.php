            ...
            <div class="collapse navbar-collapse " id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'contact us ')? 'active' : '' ?>" href="./?page=contactus ">Contact us </a>
                    </li>
                    <li class="nav-item">
  <a class="nav-link <?php echo ($page == 'qualifications') ? 'active' : ''; ?>" href="./?page=qualifications">Qualifications</a>
</li>
